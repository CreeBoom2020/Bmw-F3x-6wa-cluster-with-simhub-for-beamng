...
bool GRPMOND = true;               // set to true when u have a diesel cluster with an petrol RPM disc
bool EDITEDSELUA = true;          // set to false if u didnt replace the simhubextras.lua in ur bmeang folder
bool checkengwhenoff = true;     // set to false if u dont want the check engine lamp on when the engine is off
int setlanguage = 1;            // Set to 1 for german and 2 for Englisch
int setcorf = 1;               // Set to 1 for 1 c° and 2 for f°
int setmpgl100orkml = 1;      // Set to 1 for l/100 set to 2 for mpg and 3 for km/l
int setkmormiles = 1;        // Set to 1 for km and to 2 for miles
int backlight = 100;        // Set backlight brightnes 0-100
int drivemod = 5;          // drivingmode 1= Traction, 2= Comfort, 4= Sport, 5= Sport+, 6= DSC off, 7= Eco pro




// ----------------------------------------------------- HW SETTINGS, PLEASE REVIEW ALL -------------------------------------------
#define DEVICE_NAME "BMW F3x - Dash" //{"Group":"General","Name":"DEVICE_NAME","Title":"Device name,\r\n make sure to use a unique name when using multiple arduinos","DefaultValue":"SimHub Dash","Type":"string","Template":"#define DEVICE_NAME \"{0}\""}
#define DEVICE_UNIQUE_ID "36417486-1bdc-4624-a6c5-306a86447b87" //{"Name":"DEVICE_UNIQUE_ID","Type":"uniqueid"}
